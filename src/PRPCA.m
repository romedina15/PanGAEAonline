function [pano, L, E, S, S_disp, Lreg, Ereg, Sreg, Sreg_disp] = PRPCA(Yreg,Y,varargin)
% function [Lhat,Ehat,Shat] = PRPCA(Yreg,Y,varargin)
%
...
% Parse RPCA inputs
[mask, height, width, lambdaL, lambdaE, lambdaS, r, nIters, nItersS, dimS, flag, cleanLS] ...
...
% Parsed RPCA inputs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [mask, height, width, lambdaL, lambdaE, lambdaS, r, nIters, nItersS, dimS, flag, ...
